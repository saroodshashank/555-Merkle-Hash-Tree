...
class MerkleTree:
    ...
    def __buildTree(self, values: List[str]) -> None:
        ...
        leaves: List[Node] = [Node(None, None, Node.file_sha_hash(e), e) for e in values]
        if len(leaves) % 2 == 1:
...
def mixmerkletree() -> None:
    ...
    elems = list()
    elems.append("samplefile1.txt")
    elems.append("samplefile2.txt")
    elems.append("samplefile3.txt")
    elems.append("samplefile4.txt")
    print(elems)
